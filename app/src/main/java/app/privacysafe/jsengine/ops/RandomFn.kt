...
class RandomFn : InjectedSyncHandler("crypto_random") {

	private val random = SecureRandom()

	@OptIn(ExperimentalSerializationApi::class)
	override fun call(argsBytes: ByteArray): ByteArray? {
		val (numOfBytes) = ProtoBuf.decodeFromByteArray<NumOfBytesArgs>(argsBytes)
	...
	@Serializable
	data class NumOfBytesArgs(val numOfBytes: Int)
